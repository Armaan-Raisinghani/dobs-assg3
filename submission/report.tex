...
\begin{itemize}[leftmargin=1.5em]
    \item GitHub repository: \url{https://github.com/Armaan-Raisinghani/dobs-assg3/tree/final}
    \item YouTube demonstration video: \url{https://youtu.be/ufHVakO_iEE}
\end{itemize}
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item However, it was not completely perfect. After strong shaking and some time at rest, it would still show some slow drift of $\approx 5$\textdegree yaw, which is likely due to the limitations of the sensor calibration and the correction gains.
